...
def build_minigames_charmap(glyph_map_path: Path | str | None = None) -> dict[str, int]:
    ...
    Strictly guarantees canonical mapping:
      Ё = 0x0007, А..Я = 0x0008..0x0028, а..я = 0x0029..0x0050, ё = 0x0051
      « = 0x0005, » = 0x0006, Space = 0x007D
...
# Cyrillic letters and symbols 0x0005..0x0056 plus space 0x007D and all other Bank 0 glyphs in DEFAULT_CHARMAP,
